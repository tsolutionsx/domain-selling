    ...
    >
      ...
      <button
        className={clsx(
          ...
          "w-[113px] small:w-[52px] border border-primary",
          "small:hidden"
        )}
      >
        <span className="text-[12px] text-primary">{"Following"}</span>
      </button>
      <div className="text-primary p-2 rounded-full border border-primary hidden small:block">
        <GoThumbsdown className="hidden small:block w-5 h-5 small:rounded-full" />
      </div>
    </Flex>
  );
};
